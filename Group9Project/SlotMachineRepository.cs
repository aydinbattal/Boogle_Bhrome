...
namespace Group9Project
{
    ...
    {
        public static List<SlotMachineHistoryTemplate> GetHistory()
        {
            List<SlotMachineHistoryTemplate> history = new List<SlotMachineHistoryTemplate>();
            history.Add(new SlotMachineHistoryTemplate
            {
                Year = "1891",
